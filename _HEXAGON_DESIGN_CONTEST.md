...
We're looking for the perfect hexagon logo for the **uteals** package! Help us create a visual identity that represents our utilities and extensions for the teal framework.
...
2. **Create** your hexagon design as PNG (recommended size: 181x209 pixels)
3. **Add** your design to the `hex_designs/` folder with filename: `uteals_hex_[yourname].png`
4. **Include** a brief description in `hex_designs/README.md` explaining your design concept
5. **Submit** a pull request with title: "Hexagon design submission: [Your Design Name]"
